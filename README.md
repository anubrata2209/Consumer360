## Consumer360 — Customer Segmentation & CLV Analytics
...
- Discover product associations (Market Basket Analysis)
  
---

##   Tech Stack
- SQL (MySQL) → Data extraction & cleaning
- Python (Pandas, Matplotlib, Seaborn, Lifetimes, MLxtend) → Analysis & modeling
